...
var preg = [
	...
	{categorias: 'Historia', preguntas: [
		...
		{textoEnunciado: '¿Sabías quién descubrió América?', imagenCorrecta: 'coloncristobal.jpg', imagenIncorrecta: 'americovespucio.jpg', correcta: 'Cristóbal Colón', incorrecta: 'Américo Vespucio', incorrectaExplicacion: '<span>¡Uy lo siento!</span> América debería llamarse Columba, porque su descubridor fue Cristóbal Colón. Sin embargo, Américo Vespucio acabó por imponerse sobre Colón. Podría resumirse en que Américo escribía mejor que Colón, de 1499 a 1502 realizó varios viajes a América. <span> Mientras que Cristóbal Colón viajo a América en 1492. </span>', correctaExplicacion: '<span>¡Muy bien!</span> Fue una expedición marítima capitaneada por Cristóbal Colón, al servicio de los Reyes Católicos, Isabel y Fernando de Castilla y Aragón, que partió el 3 de agosto del 1492 del Puerto de Palos de la Frontera. Participaron tres embarcaciones: la carabela Pinta, la carabela Niña y la carabela Santa María <span> Mientras que el Américo Vespucio viajo a América en 1499.</span>', estado: false},
		...
		{textoEnunciado: '¿Sabías qué faraón comenzó la construcción de las pirámides?', imagenCorrecta: 'dyeser.jpg', imagenIncorrecta: 'sejemjet.jpg', correcta: 'Faraón Dyeser', incorrecta: 'Faraón Sejemjet', incorrectaExplicacion: '<span>¡Uy lo siento!</span> Gobernó en 2645 - 2638 a. C. Como su predecesor, Dyeser, Sejemjet inició la construcción de una pirámide escalonada en Saqqara, pero sólo las gradas más bajas estaban terminadas en el momento de su muerte. Algunos egiptólogos creen que la pirámide de Sejemjet habría sido más grande que la de Dyeser si se hubiera terminado. <span> Mientras que el Faraón Dyeser gobernó de 2665 a 2645 a. C. y comenzó la construcción de las pirámides.</span>', correctaExplicacion: '<span>¡Muy bien!</span> Gobernó de ca. 2665 a 2645 a. C. Este periodo se inicia bajo la Dinastía III, la capital se estableció en Memfis, y es esta dinastía, bajo el mandato del Faraón Dyeser, donde los egipcios comienzan a erigir esas maravillosas y colosales construcciones llamadas Pirámides. <span> Mientras que Faraón Sejemjet gobernó en 2645 - 2638 a. C. y solo continuó su construcción de las piramides.</span>', estado: false},
		{textoEnunciado: '¿Sabías quién inventó los auriculares?', imagenCorrecta: 'nathanielbaldwin.jpg', imagenIncorrecta: 'grahambell.jpg', correcta: 'Nathaniel Baldwin', incorrecta: 'Alexander Graham Bell', incorrectaExplicacion: '<span>¡Uy lo siento!</span> En 1876 Alexander Graham Bell inventó el teléfono y por primera vez incluyó un micrófono funcional que usaba un electroimán, este era conocido como transmisor líquido donde el diafragma se adjuntaba a una varilla conductora en una solución de ácido. <span> Mientras que Nathaniel Baldwin fue quien invento los auriculares.</span>', correctaExplicacion: '<span>¡Muy bien!</span> La invención de los audífonos se remonta a 1910 en Utah en Estados Unidos a finales del año 1930, fue Nathaniel Baldwin quien los creó y dejó al mundo un gadget hoy indispensable. <span> Mientras que Graham Bell fue quien inventó el telefono.', estado: false},
		{textoEnunciado: '¿Sabías quien gobernaba Rusia durante la segunda guerra mundial?', imagenCorrecta: 'stalin.jpg', imagenIncorrecta: 'malenkov.jpg', correcta: 'Iósif Stalin', incorrecta: 'Gueorgui Malenkov', incorrectaExplicacion: '<span>¡Uy lo siento!</span> Fue el siguiente gobernante después de la muerte de Stalin que hasta febrero de 1955, Malenkov a través del cargo de Presidente del Consejo de Ministros, estuvo encerrado en una lucha por el poder contra Jrushchov después de la segunda guerra mundial. <span> Mientras que Iósif Stalin gobernó durante la segunda guerra mundial.</span>', correctaExplicacion: '<span>¡Muy bien!</span> Durante del Segunda Guerra Mundial (1939-1945) Rusia era la principal de las 15 repúblicas que integraban la Unión de Repúblicas Socialistas Soviéticas, llamada comúnmente Unión Soviética. Y su jefe de gobierno era el dictador Iósif Vissariónovich Dzhugashvili, más conocido como José Stalin.<span> Mientras que Gueorgui Malenkov lucho por el gobierno después de la segunda guerra mundial.</span>', estado: false},
		...
		{textoEnunciado: '¿Sabías qué nombre recibe el hijo de Osiris e Isis en la mitología egipcia?', imagenCorrecta: 'horus.jpg', imagenIncorrecta: 'tot.jpg', correcta: 'Horus', incorrecta: 'Thot', incorrectaExplicacion: '<span>¡Uy lo siento!</span> Thot está considerado dios de la sabiduría y tenía autoridad sobre todos los dioses. También fue el inventor de la escritura, patrón de los escribas, de las artes y las ciencias. Como dios de la escritura, era el inventor de todas las palabras, del lenguaje articulado. <span> Mientras que Horus fue el hijo de Osiris e Isis.</span>', correctaExplicacion: '<span>¡Muy bien!</span> Hijo de Osiris e Isis, Horus era un poderoso y muy antiguo dios celeste de Egipto, tan antiguo que ya se reconocía  en la época predinástica. Con su forma de halcón, despertó gran devoción entre sus fieles y levantaron templos en su honor. <span> Mientras que Thot está considerado dios de la sabiduría y tenía autoridad sobre todos los dioses.</span>', estado: false},
		{textoEnunciado: '¿Sabías quien fue el primer zar de Rusia?', imagenCorrecta: 'ivanterrible.jpg', imagenIncorrecta: 'simeon.jpg', correcta: 'Iván IV', incorrecta: 'Simeón Bekbulátovich', incorrectaExplicacion: '<span>¡Uy lo siento!</span> El año 1574, durante el período de la Opríchnina, Iván el Terrible deja Moscú después de ejecutar a numerosos Boyardos y se retira en su palacio de Aleksándrov. Durante este tiempo nombró a Simeón Bekbulátovich como Soberano de Todas las Rusias <span> Mientras que el primer zar fue Iván IV más conocido como Iván el Terrible.</span>', correctaExplicacion: '<span>¡Muy bien!</span> Iván IV Vasílievich, llamado Iván el Terrible (Kolómenskoye, Rusia, 25 de agosto de 1530 - Moscú, 18 de marzo de 1584), fue un zar de Rusia (1547-1584), el primero en llevar el título de zar (desde 1547) y es considerado como uno de los creadores del Estado ruso. <span> Mientras que Simeón Bekbulátovich fue nombrado soberano por Iván IV después de su retiro.</span>', estado: false},
	]},
	//Todo
	{categorias: 'Todo'},
	//Curiosidades
